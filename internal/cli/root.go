...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "notion-pp-cli",
		Short: "Manage notion resources via the notion API",
		Long: `Manage notion resources via the notion API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'notion-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	...
	rootCmd.AddCommand(newChildrenCmd(flags))
